...
const DigitalArchives = () => {
  ...
  const archiveStats = [
    { title: "MANUSCRIPTS", count: "2,847", color: "bg-blue-600", icon: BookOpen },
    { title: "ARTIFACTS", count: "1,523", color: "bg-orange-600", icon: Camera },
    { title: "AUDIO RECORDS", count: "892", color: "bg-green-600", icon: FileText },
    { title: "VIDEO ARCHIVES", count: "456", color: "bg-purple-600", icon: PlayCircle }
  ];
  ...
  const preservationTech = [
    {
      title: "AI SCANNING",
      description: "Advanced computer vision algorithms analyze and catalog every detail of artifacts",
      icon: Cpu,
      color: "bg-blue-600"
    },
    {
      title: "DIGITAL RESTORATION",
      description: "Machine learning techniques restore damaged texts and faded artwork",
      icon: Shield,
      color: "bg-green-600"
    },
    {
      title: "BLOCKCHAIN SECURITY",
      description: "Immutable ledger technology ensures authenticity and prevents tampering",
      icon: Database,
      color: "bg-purple-600"
    }
  ];
  ...
  const workflowSteps = [
    { step: "1", title: "Documentation", description: "High-resolution photography and 3D scanning" },
    { step: "2", title: "Digital Processing", description: "AI-powered analysis and metadata extraction" },
    { step: "3", title: "Restoration", description: "Digital restoration using machine learning algorithms" },
    { step: "4", title: "Cataloging", description: "Multi-language tagging and classification" },
    { step: "5", title: "Archive", description: "Secure storage with blockchain verification" },
    { step: "6", title: "Access", description: "Public access through our digital platform" }
  ];
  ...
  const timelineEvents = [
    {
      ...
      description: "Establishment of one of Sikkim's most important Buddhist centers",
  ...
  const educationalResources = [
    {
      ...
      description: "Comprehensive guides for researchers and scholars studying Buddhist heritage",
      icon: BookOpen,
      color: "bg-blue-600"
    },
    {
      title: "VIRTUAL WORKSHOPS",
      description: "Online sessions on conservation techniques and digital preservation",
      icon: Users,
      color: "bg-green-600"
    },
    {
      title: "CERTIFICATION PROGRAMS",
      description: "Professional certification in digital heritage and conservation methods",
      icon: Award,
      color: "bg-purple-600"
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: "The AI-powered search capabilities have revolutionized how we access ancient texts.",
    ...
    },
    {
      ...
      rating: 5,
      comment: "Incredible preservation quality. The 3D scans capture details invisible to the naked eye.",
      image: "/lovable-uploads/a860a24e-abf1-45c7-919f-ec1d134f8e48.png"
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-16">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 leading-relaxed">
              Preserving Sikkim's sacred Buddhist heritage through cutting-edge AI technology, 
              3D digitization, and immersive virtual experiences for future generations.
            </p>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-white text-center mb-16">Archive Overview</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {archiveStats.map((stat, index) => (
              <Card key={index} className={`${stat.color} border-none text-white overflow-hidden relative`}>
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">AI-Powered Heritage Search</h2>
            <p className="text-gray-300 text-lg">Discover centuries of wisdom with intelligent search capabilities</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-700 rounded-2xl p-8">
              ...
              <div className="flex flex-wrap gap-2">
                {["Sanskrit", "Tibetan", "Lepcha", "15th Century", "Rumtek", "Religious Text"].map((tag) => (
                  <Badge key={tag} variant="secondary" className="bg-gray-600 text-gray-200 hover:bg-gray-500">
                    {tag}
                  </Badge>
                ))}
              </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-white text-center mb-16">Featured Heritage Items</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {featuredItems.map((item, index) => (
              <Card key={index} className="bg-gray-800 border-gray-700 overflow-hidden hover:shadow-2xl transition-all duration-300 group">
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Advanced Preservation Technology</h2>
            <p className="text-gray-300 text-lg">Cutting-edge tools ensuring heritage preservation for millennia</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {preservationTech.map((tech, index) => (
              <Card key={index} className={`${tech.color} border-none text-white overflow-hidden relative group hover:scale-105 transition-transform duration-300`}>
                <div className="absolute top-0 right-0 opacity-20">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-white mb-8">Conservation Workflow</h2>
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-white text-center mb-16">Research Portal</h2>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-white text-center mb-16">Historical Timeline</h2>
                ...
                <div key={index} className={`flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                  <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8'}`}>
                    <div className="bg-gray-800 rounded-2xl p-6 hover:shadow-2xl transition-shadow duration-300">
                      <div className="text-yellow-400 font-bold text-2xl mb-2">{event.year}</div>
                      <h3 className="text-white font-semibold text-xl mb-3">{event.title}</h3>
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-white text-center mb-16">Global Collaboration Network</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-gray-700 rounded-2xl p-8">
              ...
              />
              <h3 className="text-white font-semibold text-xl mb-4">Join Our Network</h3>
              <p className="text-gray-400 mb-6">
                Connect with researchers, institutions, and cultural preservationists worldwide 
                to advance digital heritage conservation.
              </p>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-white text-center mb-16">Educational Resources</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {educationalResources.map((resource, index) => (
              <Card key={index} className={`${resource.color} border-none text-white overflow-hidden relative group hover:scale-105 transition-transform duration-300`}>
                <div className="absolute top-0 right-0 opacity-20">
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-white text-center mb-16">Virtual Reality Experiences</h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h3 className="text-3xl font-bold text-white mb-6">Immerse Yourself in History</h3>
              <p className="text-gray-300 text-lg mb-8">
                Step into ancient monasteries, walk through sacred halls, and interact with 
                historical artifacts in stunning virtual reality environments.
              </p>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                  <span className="text-gray-300">Interactive artifact examination</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                  <span className="text-gray-300">Historical timeline navigation</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                  <span className="text-gray-300">Multi-language audio guides</span>
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-white text-center mb-16">Heritage Community</h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Testimonials */}
            <div>
              <h3 className="text-2xl font-bold text-white mb-8">What Researchers Say</h3>
              <div className="space-y-6">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-gray-400 text-sm mb-3">{testimonial.role}</div>
                ...
                <CardContent className="p-6">
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="text-white font-medium mb-2 block">Role/Affiliation</label>
                        <Input 
      ...
      <section className="py-20 bg-gray-800">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-300 text-lg mb-8">
            Get the latest updates on new digitizations, research findings, and virtual experiences.
          </p>
