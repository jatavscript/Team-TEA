...
const ImmersiveExperience = () => {
  const features = [
    {
      ...
      description:
        "Explore monastery interiors with immersive panoramic views and guided narration.",
    ...
    },
    {
      ...
      description:
        "Intelligent chatbot providing personalized monastery recommendations and cultural insights.",
    ...
    },
    {
      ...
      description:
        "Geo-tagged monastery locations with routes, transport, and nearby attractions.",
    ...
    },
    {
      ...
      description:
        "Preserved manuscripts, murals, and artifacts with AI-powered search capabilities.",
      status: "5000+ Items",
      icon: Archive,
  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative max-w-[1400px] sm:px-12 mx-auto px-6">
        {/* Section Header */}
        <motion.div
        ...
        >
          <motion.h2
            className="text-5xl md:text-6xl lg:text-7xl pb-6 font-bold bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 bg-clip-text text-transparent mb-8  leading-tight"
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Cutting-edge technology meets ancient wisdom in our comprehensive
  ...
  return (
    <div className="group h-full">
      <div className="relative w-full h-80 transition-all duration-500 ease-in-out group-hover:scale-105">
        {/* Main Card */}
        <div
          className={`h-full rounded-3xl ${getGradientClass(
            gradient
          )} transition-all duration-500 ease-in-out shadow-xl group-hover:shadow-2xl group-hover:shadow-orange-500/20 relative overflow-hidden`}
        >
          ...
          <div className="relative z-10 p-8 h-full flex flex-col">
            ...
            >
              <span
                className={`text-sm font-semibold text-black-500 bg-white/10 px-3 py-1 rounded-full`}
              >
                {status}
              </span>
