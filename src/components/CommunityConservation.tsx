...
const CommunityConservation = () => {
  ...
  const artisans = [
    { name: "Pema Lhamo", location: "Gangtok Painter", rating: 5, specialty: "Thangka Art" },
    { name: "Tenzin Norbu", location: "Wood Carver", rating: 5, specialty: "Traditional Woodcraft" },
    { name: "Dolma Sherpa", location: "Mask Artist", rating: 5, specialty: "Ceremonial Masks" }
  ];

  const conservationStats = [
    { label: "Manuscripts Digitized", value: 1247, max: 1500, color: "bg-monastery-gold" },
    { label: "Murals Restored", value: 956, max: 1200, color: "bg-green-500" },
    { label: "Local Jobs Created", value: 83, max: 100, color: "bg-orange-500" }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto">
            Supporting local communities while preserving sacred heritage for future generations
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <Card className="shadow-monastery border-monastery-gold/20 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-950/20 dark:to-orange-950/20">
            <CardHeader className="text-center pb-3">
              ...
              <CardTitle className="text-xl text-monastery-burgundy">Local Artisans</CardTitle>
            </CardHeader>
              ...
              {artisans.map((artisan, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-xs text-monastery-gold">{artisan.rating}</span>
                  </div>
                </div>
              ))}
          ...
          <Card className="shadow-monastery border-monastery-gold/20 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20">
            <CardHeader className="text-center pb-3">
              ...
              <CardTitle className="text-xl text-monastery-burgundy">Conservation Impact</CardTitle>
            </CardHeader>
          ...
          <Card className="shadow-monastery border-monastery-gold/20 bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-950/20 dark:to-rose-950/20">
            <CardHeader className="text-center pb-3">
              ...
              <CardTitle className="text-xl text-monastery-burgundy">Get Involved</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {opportunities.map((opportunity, index) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <Badge 
                      variant={opportunity.difficulty === 'Beginner' ? 'default' : opportunity.difficulty === 'Advanced' ? 'destructive' : 'secondary'}
                      className="text-xs"
                    >
