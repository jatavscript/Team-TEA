      ...
      <div className="max-w-[1400px] sm:px-12 mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Seamlessly connect with local transport, accommodation, and cultural
            experiences
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {tourPackages.map((tour, index) => (
            <Card
              key={index}
              className="overflow-hidden group hover:shadow-elevated transition-all duration-300"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {services.map((service, index) => (
            <Card
              key={index}
              className="text-center group hover:shadow-monastery transition-all duration-300"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Our integrated platform connects you directly with verified
                local tour operators, transport providers, and accommodation
                partners for authentic experiences.
              </p>
